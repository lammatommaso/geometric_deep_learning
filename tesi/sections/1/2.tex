...
\begin{document}
    ...
    \begin{defn}
        ...
        a family of non empty subsets of $\mc{V}$ such that:
        \begin{enumerate}[(i)]
    ...
    % The geometric realization is unluckily not a functor on the whole category of abstract simplicial complexes due to the
