...
\begin{document}
    One simple problem which might lead to simplicial complexes is the following, let A and B be to 
    point clouds is some space, is there a way to say that they represent the same data?
    One can see simplcial complexes as sets constructed from 
    topological infromation about the set that was lost in the sampling, this set shall . 
    ...
    simplicial complexes as a realization of more abstract objects called \ii{abstract simplicial complexes} \cite{rotman}.
