...
\begin{document}
    ...
    \begin{defn}
        ...
        \ii{coboundary maps}, is the group homomorphism defined by
    ...
    \begin{defn}
        ...
        where $\im d_{p-1}$ is the group of simplicial \ii{p-cocycles} and
        $\ker d_p$ is the group of simplicial \ii{p-coboundaries}.
    \end{defn}
