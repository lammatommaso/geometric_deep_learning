...
\begin{document}
    ...
    It is important to notice that in order to define a symmetry we need to choose a classification, and the symmetries do not only depend on the signal space.
\end{document}